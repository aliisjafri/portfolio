const About = () => (
  <div>
    <div className="mt-4 flex-col items-center justify-center">
      ...
      />
      <p className="m-2 mt-6 text-center text-3xl font-bold text-indigo-500 dark:text-amber-400">
      ...
      <div className="mt-6 flex justify-center">
        ...
        >
          <i className="fa-brands fa-linkedin mr-4 text-4xl hover:text-indigo-500 dark:hover:text-amber-400"></i>
        </a>
        <a
          aria-label="Go to Ali Jafri's Twitter profile"
          href="https://twitter.com/AliJafri315"
        >
          <i className="fa-brands fa-twitter mr-4 text-4xl hover:text-indigo-500 dark:hover:text-amber-400"></i>
        </a>
        <a
          aria-label="Go to Ali Jafri's GitHub profile"
          href="https://github.com/aliisjafri"
        >
          <i className="fa-brands fa-github mr-4 text-4xl hover:text-indigo-500 dark:hover:text-amber-400"></i>
        </a>
        <a
          aria-label="Send Ali Jafri an email message"
          href="mailto:jafrimoali@gmail.com"
        >
          <i className="fa-solid fa-paper-plane text-4xl  hover:text-indigo-500 dark:hover:text-amber-400"></i>
        </a>
      </div>
    </div>
  </div>
