...
const About = () => (
  <div className="mt-8 flex-col items-center justify-center text-center">
    <img
      ...
      className="mx-auto mt-6 h-32 w-32 transform rounded-3xl drop-shadow-[0_0_20px_#fef08a] transition-all duration-200 dark:drop-shadow-[0_0_20px_#fbbf24] sm:h-48 sm:w-48 2xl:h-64 2xl:w-64"
    />
    <div className="m-2 mt-8 flex justify-center">
      <h1 className="max-w-3xl text-4xl font-extrabold tracking-tight text-yellow-200 dark:text-amber-400 sm:text-5xl 2xl:text-6xl">
        Hello there! <span className="emoji-wave pr-2">👋🏼</span>
        <br></br>My name is Ali and I like to build 🛠 things!
      </h1>
    </div>
