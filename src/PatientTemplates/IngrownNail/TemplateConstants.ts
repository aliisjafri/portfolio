export const TEXT = {
  ...
  PT_INSTRUCTION: ` nail avulsion `,
  EXPLAINED: ` phenol. Explained to the patient that chances of reoccurrence of ingrown nail are possible after procedure, and that continued/worsening pain and infection are possible if procedure is not performed. Patient understands risks benefits alternatives and post procedure course and wants to proceed.`,
